<html><head>
    ...
    <div class="section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <a href="#"><img class="img-responsive" src="https://i1.sdlcdn.com/static/img/marketing-mailers/mailer/2016/Ankita/12thsept_header_DOD_web.jpg"></a>
          </div>
        </div>
      </div>
    </div>
    <div class="section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1 class="new1">Super deals of the day</h1>
          </div>
        </div>
      </div>
    </div>
    <div class="section">
      <div class="container">
        <div class="row">
          <div class="col-md-3">
            <img src="https://n1.sdlcdn.com/imgs/b/s/6/166x194/SDL478833219_1-930ba.jpg" class="img-responsive">
            <h2>watch 20% off
              <br>Fastrack blue leather analog watch</h2>
            <p>Rs.1393</p>
          </div>
          <div class="col-md-3">
            <img class="img-responsive" src="https://n1.sdlcdn.com/imgs/c/v/z/166x194/KBC_52122pc-41177.jpg">
            <h2>Crystal nonstick
              <br>cookware 30%off
              <br>
              <br>
          ...
          <div class="col-md-3">
            <img src="https://n1.sdlcdn.com/imgs/c/u/j/166x194/bajaj_flora_instant-9fdef.jpg" class="img-responsive img-rounded">
            <h2>bajaj 3 ltrs flora
              <br>instant geyser
              <br>30% off
              <br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</h2>
            <p>Rs.68000</p>
          ...
          <div class="col-md-3">
            <img src="https://n1.sdlcdn.com/imgs/a/n/z/166x194/Arise-Presse-Dry-Iron-Light-SDL483982853-1-35cab.jpg" class="img-responsive">
            <h2>Arise pressie 1000w dry iron light 25%off
              <br>
              <br>
            </h2>
            <p>Rs.22200</p>
    ...
    <div class="section">
      <div class="container">
        <div class="row">
          <div class="col-md-3">
            <img src="https://n1.sdlcdn.com/imgs/a/p/j/230x258/Intel-Dual-Core-G-3220-SDL046577472-1-de696.webp" class="img-responsive">
            <h2>intel dual core pentium 30%off</h2>
            <p>RS . &nbsp;42000</p>
          </div>
          <div class="col-md-3">
            <img src="https://n1.sdlcdn.com/imgs/b/u/4/166x194/KALENJI-Ekiden-Men-Running-T-SDL384470259-1-41584.jpg" class="img-responsive">
            <h2>
              <br>
              <br>Reebok mens&nbsp;
              <br>&nbsp;tshirt&nbsp;25%off</h2>
          ...
          <div class="col-md-3">
            <img src="https://n1.sdlcdn.com/imgs/b/v/0/166x194/Philips-Philips-BT1000-15-Trimmers-SDL129005626-1-dcb46.jpg" class="img-responsive img-rounded">
            <h2>
              <br>
              <br>Philips 15 -22H trimmer blue 50%
              <br>
            </h2>
            <p>Rs. 48960</p>
          </div>
          <div class="col-md-3">
            <img src="https://n1.sdlcdn.com/imgs/b/6/c/166x194/Bags_opt_1_-34246.jpg" class="img-responsive">
            <h2>
              <br>
              <br>HP laptop bagpack
              <br>20%off</h2>
            <p>Rs. 48800</p>
          </div>
        </div>
    ...
    <div class="section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1 class="new">Deals coming on 25th september</h1>
          </div>
        </div>
        <div class="row">
          <div class="col-md-3">

<html><head>
    ...
    <div class="section">
      <div class="container">
        <div class="row">
          <div class="col-md-3">
            <img src="https://n3.sdlcdn.com/imgs/b/w/1/230x258/AMD-4-4-GHz-AM3-SDL972943746-1-d49b6.webp" class="img-responsive">
            <h2>AMD 3.5Ghz</h2>
            <p>Rs.13939</p>
          </div>
          <div class="col-md-3">
            <img class="img-responsive" src="https://n1.sdlcdn.com/imgs/a/8/e/230x258/Intel-Core-i5-6600K-3-SDL739139403-1-14210.webp">
            <h2>intel core 6610 3.5ghz</h2>
            <p>Rs. 68000</p>
          </div>
          <div class="col-md-3">
            <img src="https://n1.sdlcdn.com/imgs/a/l/r/230x258/Intel-Core-i5-4690-Processor-SDL147074365-1-666ae.webp" class="img-responsive img-rounded">
            <h2>intel i5 6693h 3.5ghz<br></h2>
            <p>Rs.68000</p>
          </div>
          <div class="col-md-3">
            <img src="https://n2.sdlcdn.com/imgs/a/r/u/230x258/Amd-Fm2-A4-3-2-SDL018018457-1-70117.webp" class="img-responsive">
            <h2>AMD fm24 A8</h2>
            <p>Rs.22200</p>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-3">
            ...
            <h2>intel dual core pentium</h2>
            <p>RS . &nbsp;42000</p>
          </div>
          <div class="col-md-3">
            <img src="https://n4.sdlcdn.com/imgs/a/r/o/230x258/Intel-E8400-Core-2-Duo-SDL285779070-1-95428.webp" class="img-responsive">
            <h2>intel core2 duo3<br>3.5 ghz</h2>
            <p>Rs. 40000</p>
          </div>
          <div class="col-md-3">
            <img src="https://n4.sdlcdn.com/imgs/b/w/1/230x258/AMD-4-GHz-AM3-FX-SDL972968336-1-ff1b9.webp" class="img-responsive img-rounded">
            <h2>AMD A4 series 5<br>3.5ghz</h2>
            <p>Rs. 48960</p>
          </div>
          <div class="col-md-3">
            <img src="https://n2.sdlcdn.com/imgs/a/g/k/230x258/SDL037646104_1387514491_image1-0b67b.webp" class="img-responsive">
            <h2 contenteditable="true">AMD 658 65 w<br>3.5ghz</h2>
            <p>Rs. 48800</p>
          </div>
        </div>
      </div>
